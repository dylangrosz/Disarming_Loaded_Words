...
class Parser:
    ...
    def printInfo(self):
        ...
        print ("Grammar\t" +
               str(Numberer.getGlobalNumberer("states").total()) + '\t' +
               str(Numberer.getGlobalNumberer("tags").total()) + '\t' +
               str(Numberer.getGlobalNumberer("words").total()) + '\t' +
               str(self.parser.pparser.ug.numRules()) + '\t' +
               str(self.parser.pparser.bg.numRules()) + '\t' +
               str(self.parser.pparser.lex.numRules()))
